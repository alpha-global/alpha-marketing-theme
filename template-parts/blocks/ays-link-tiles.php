			...
			<a href="<?php if($tile['country_selector'] == 'on'){ echo 'javascript:void(0)'; } else { echo $tile['link']['url']; } ?>" class="ays-link-tile ays-link-tile-<?php echo $i; ?> <?php if($tile['country_selector'] == 'on'){ echo 'ays-link-tile-country-selector'; } ?>">
				...
				<div class="ays-link-button">
					...
					<svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M39.707 27.207C40.9277 25.9863 40.9277 24.0039 39.707 22.7832L20.957 4.0332C19.7363 2.8125 17.7539 2.8125 16.5332 4.0332C15.3125 5.25391 15.3125 7.23633 16.5332 8.45704L33.0762 25L16.543 41.543C15.3223 42.7637 15.3223 44.7461 16.543 45.9668C17.7637 47.1875 19.7461 47.1875 20.9668 45.9668L39.7168 27.2168L39.707 27.207Z" fill="white"/>
					</svg>
				</div>
